...
```javascript
import dmeanpn from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmeanpn@v0.2.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dmeanpn/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/stats-base-dmeanpn/actions/workflows/test.yml?query=branch:v0.2.1
